...
const packageJsonPath = path.join(
	__dirname,
	"../node_modules/@fortawesome/svelte-fontawesome/package.json",
);
...
try {
	...
	console.log(
		"✓ Fixed @fortawesome/svelte-fontawesome package.json for Vite 6 compatibility",
	);
} catch (error) {
	console.error(
		"❌ Error patching @fortawesome/svelte-fontawesome:",
		error.message,
	);
