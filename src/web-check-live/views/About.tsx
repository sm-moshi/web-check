  ...
  return (
    <div>
      <AboutContainer>
        <Nav>
          <HeaderLinkContainer>
            <a target="_blank" rel="noreferrer" href="https://github.com/lissy93/web-check (& https://github.com/sm-moshi/web-check)"><Button>View on GitHub</Button></a>
          </HeaderLinkContainer>
        </Nav>
        ...
        <Section>
          ...
          <p>
            ...
            Source code and self-hosting docs are available on <a target="_blank" rel="noreferrer" href="https://github.com/lissy93/web-check (& https://github.com/sm-moshi/web-check)">GitHub</a>.
        ...
        <Section>
          {supportUs.map((para, index: number) => (
            <p key={`support-${index}`} dangerouslySetInnerHTML={{ __html: para }} />
          ))}
        </Section>
        ...
        <Section>
          ...
          <b>
            <a target="_blank" rel="noreferrer" href="https://github.com/lissy93/web-check (& https://github.com/sm-moshi/web-check)">Web-Check</a> is distributed under the MIT license,
