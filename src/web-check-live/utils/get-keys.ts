...
const keys = {
  shodan: import.meta.env.PUBLIC_SHODAN_API_KEY
    || import.meta.env.VITE_SHODAN_API_KEY
    || import.meta.env.REACT_APP_SHODAN_API_KEY
    || "default_value_if_not_set",
  whoApi: import.meta.env.PUBLIC_WHO_API_KEY
    || import.meta.env.VITE_WHO_API_KEY
    || import.meta.env.REACT_APP_WHO_API_KEY
    || "default_value_if_not_set",
